...
CREATE TABLE IF NOT EXISTS session_recordings (
    ...
    CONSTRAINT fk_session_recordings_form_id FOREIGN KEY (form_id) REFERENCES forms(id) ON DELETE CASCADE
);

-- Create indexes for efficient querying
CREATE INDEX IF NOT EXISTS idx_session_recordings_owner_uid ON session_recordings (owner_uid);
CREATE INDEX IF NOT EXISTS idx_session_recordings_form_id ON session_recordings (form_id);
